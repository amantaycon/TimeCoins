...
//	            }
	...
	@PutMapping("/u/message/{messageId}/seen")
	public ResponseEntity<Boolean> markMessageAsSeen(
        ...
        return ResponseEntity.ok(messageServiceIn.updateSeenMessage(messageId, userId));
    }
